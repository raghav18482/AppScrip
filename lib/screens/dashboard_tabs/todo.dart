...
class _TodoListTabState extends State<TodoListTab> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      ...
      final incompleteTodos = todoProvider.todos.where((todo) => !todo.completed && !todo.inProgress).toList();
      if (incompleteTodos.length < 15 && todoProvider.hasMore) {
        todoProvider.loadMoreTodos();
      }
    });
  }
    ...
    return Consumer<TodoProvider>(
      builder: (context, todoProvider, child) {
        ...
        return ListView.builder(
          ...
          itemCount: incompleteTodos.length + (todoProvider.hasMore ? 1 : 0),
          itemBuilder: (context, index) {
            ...
            return Dismissible(
              ...
              child: ListTile(
                ...
                leading: Icon(Icons.task_alt, color: Colors.grey),
                trailing: InkWell(
